...
df['inicio'] = pd.to_datetime(df['ec'], errors='coerce')  # Converte para datetime, tratando erros
df['fim'] = pd.to_datetime(df['cpc'], errors='coerce')  # Converte para datetime, tratando erros
